...
assert.ok(headers["access-control-allow-origin"], "Expected access-control-allow-origin header");
assert.ok(headers["access-control-allow-methods"], "Expected access-control-allow-methods header");
